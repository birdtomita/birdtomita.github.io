(function(window) {
  ...
  var VAD = function(options) {
   ...
   if(!this.options.source)
    ...
    console.log("iterationFrequency" +this.iterationPeriod )
    ...
    this.monitor = function() {
      ...
      console.log("energy:" + energy,signal,this.energy_offset);
      ...
      if(signal > this.energy_threshold_pos) {
        ...
        console.log("signal < -this.energy_threshold_ne")
      ...
      console.log("vt:"+self.voiceTrend + " : " + new Date())
